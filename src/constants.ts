...
export const JOBS: Array<TTimelineItemProps> = [
    {
        companyName: 'xneelo',
        companyStartDate: new Date(2023, 8, 1),
    ...
    },
    {
        ...
        companyStartDate: new Date(2022, 3, 1),
        companyEndDate: new Date(2023, 7, 1),
    ...
    },
    {
        companyName: 'Rank Interactive',
        jobPosition: 'Software Engineer',
        companyStartDate: new Date(2020, 10, 1),
        companyEndDate: new Date(2022, 4, 1),
    ...
    },
    {
        ...
        companyStartDate: new Date(2018, 1, 1),
        companyEndDate: new Date(2020, 10, 1),
    ...
    },
    {
        ...
        companyStartDate: new Date(2016, 8, 1),
        companyEndDate: new Date(2018, 0, 1),
    ...
    },
    {
        ...
        companyStartDate: new Date(2015, 6, 1),
        companyEndDate: new Date(2016, 7, 1),
