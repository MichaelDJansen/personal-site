...
const Home = () => (
  <div className="flex flex-col items-center justify-between px-6 py-8 bg-quarternary gap-4 animate-[fadeIn_0.8s_ease-in-out]">
      ...
      <div className="hero-info-section flex flex-col gap-2 items-center px-12 md:flex-row-reverse md:justify-center lg:justify-around">
        <div className="hero-img-section flex items-center justify-center flex-col gap-4">
          <img
            ...
            className="profile-photo w-64 lg:w-96 aspect-square rounded-full object-cover" 
          ...
          <div className="flex items-center justify-center gap-2 mt-2">
            {SOCIAL_LINKS.map((social, index) => (
                <Link 
                  ...
                  className="social-icon focus:outline-none focus:ring-2 focus:ring-primary-500 focus:ring-offset-2 rounded"
                >
                  <img
    ...
    <RevealSection 
      id="skills-section" 
      className="flex flex-col items-center bg-tertiary w-full text-white rounded-2xl gap-4 p-4" 
      aria-labelledby="skills-heading"
    >
      <h2 id="skills-heading" className='text-xl lg:text-2xl font-bold'>Skills</h2>
      <Skills skills={SKILLS} />
      <div className="w-full overflow-hidden">
        <div className="skills-logos flex row gap-2 flex-1 flex-wrap justify-center" aria-label="Technology logos">
          {SKILL_LOGOS.map((logo, index) => (
            <div key={index} className="skill-logo-container opacity-50">
              <img 
    ...
    <RevealSection id="experience-section" aria-labelledby="experience-heading" delay={200}>
