...
const TimelineItem: React.FC<TTimelineItemProps>  = ({ 
    ...
    <div className="timeline-item grid grid-cols-[1fr_30px_2fr]">
        ...
        <div className="divider w-8">
            <span className="circle h-4 w-4 bg-white border border-black rounded-[50%] inline-block" />
            <div className="vertical-line border-l border-l-black h-full relative -top-2 left-2"/>
        </div>
